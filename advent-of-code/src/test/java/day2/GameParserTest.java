...
public class GameParserTest {
    ...
    public void testSampleB() throws Exception {
        final GameParser gameParser = new GameParser(12, 13, 14);
        assertThat(gameParser.gameIsPossible(sampleInput.get(0)).getPower()).isEqualTo(48);
        assertThat(gameParser.gameIsPossible(sampleInput.get(1)).getPower()).isEqualTo(12);
        assertThat(gameParser.gameIsPossible(sampleInput.get(2)).getPower()).isEqualTo(1560);
        assertThat(gameParser.gameIsPossible(sampleInput.get(3)).getPower()).isEqualTo(630);
        assertThat(gameParser.gameIsPossible(sampleInput.get(4)).getPower()).isEqualTo(36);
    }
